...
import { Search, Filter, MapPin, Star, Clock, Shield, LogOut, User, Calendar, CheckCircle, XCircle, AlertCircle, RefreshCw, Navigation, Map } from 'lucide-react';
...
const CustomerDashboard: React.FC = () => {
  ...
  const applyFilters = () => {
    ...
    if (filters.womenOnly) {
      filtered = filtered.filter(worker => worker.isWomenOnly);
    }
  ...
  const handleBookingSubmit = (e: React.FormEvent) => {
    ...
    const newBooking: Booking = {
      ...
      status: 'pending_admin', // Changed to go through admin first
      paymentMethod: 'cash',
      totalAmount: selectedWorker.hourlyRate * bookingForm.estimatedDuration,
      createdAt: new Date(),
      updatedAt: new Date(),
      isWomenOnly: bookingForm.isWomenOnly,
      location: {
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                >
                  ...
                  {locationSharingEnabled ? '📍 Live Location On' : '📍 Share Location'}
                </button>
              </div>
          ...
          <>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-medium text-gray-900">Filter Workers</h3>
              </div>
                ...
                <div className="flex items-end">
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) => handleFilterChange('womenOnly', e.target.checked)}
                      className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                    />
                    <span className="ml-2 text-sm text-gray-700">Women only</span>
                  </label>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
                            ...
                            <div className="mt-3 p-3 bg-purple-50 border border-purple-200 rounded-lg">
                              ...
                              {booking.liveLocationSharing.customerLocation && (
                                <div className="text-sm text-purple-700 mb-2">
                                  <strong>Your Location:</strong> {booking.liveLocationSharing.customerLocation.address}
                              ...
                              {booking.liveLocationSharing.workerLocation && (
                                <div className="text-sm text-purple-700">
                                  <strong>Worker Location:</strong> {booking.liveLocationSharing.workerLocation.address}
                                  <span className="text-xs text-purple-600 ml-2">
                              ...
                              <div className="mt-2 text-xs text-purple-600 bg-purple-100 p-2 rounded">
                                🗺️ Both you and the worker can see each other's live location for easy coordination.
                              </div>
                            </div>
                          )}
                        </div>
            ...
            {bookings.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Start by browsing and booking a worker.
                </p>
              </div>
            )}
          </div>
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    id="isWomenOnly"
                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                    checked={bookingForm.isWomenOnly}
                    onChange={(e) => setBookingForm(prev => ({ ...prev, isWomenOnly: e.target.checked }))}
                  />
                  <label htmlFor="isWomenOnly" className="ml-2 block text-sm text-gray-700">
                    Women-only service required
                  </label>
                </div>
