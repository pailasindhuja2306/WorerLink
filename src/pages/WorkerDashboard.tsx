    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">Worker profile not found</h3>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-primary-600">LabourLink</h1>
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm text-gray-700">Welcome, {worker.name}</span>
                            ...
                            <div className="mt-3 p-3 bg-purple-50 border border-purple-200 rounded-lg">
                              ...
                              {booking.liveLocationSharing.workerLocation && (
                                <div className="text-sm text-purple-700 mb-2">
                                  <strong>Your Location:</strong> {booking.liveLocationSharing.workerLocation.address}
                              ...
                              {booking.liveLocationSharing.customerLocation && (
                                <div className="text-sm text-purple-700">
                                  <strong>Customer Location:</strong> {booking.liveLocationSharing.customerLocation.address}
                                  <span className="text-xs text-purple-600 ml-2">
                              ...
                              <div className="mt-2 text-xs text-purple-600 bg-purple-100 p-2 rounded">
                                🗺️ Both you and the customer can see each other's live location for easy coordination.
                              </div>
                            </div>
                          )}
                        </div>
